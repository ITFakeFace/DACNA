...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LessonDateOffDates", b =>
                {
                    b.Property<int>("LessonDatesId")
                        .HasColumnType("int");

                    b.Property<int>("OffDatesId")
                        .HasColumnType("int");

                    b.HasKey("LessonDatesId", "OffDatesId");

                    b.HasIndex("OffDatesId");

                    b.ToTable("LessonDateOffDates");
                });
            ...
            modelBuilder.Entity("LessonDateOffDates", b =>
                {
                    b.HasOne("EVOLEC_Server.Models.LessonDate", null)
                        .WithMany()
                        .HasForeignKey("LessonDatesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
